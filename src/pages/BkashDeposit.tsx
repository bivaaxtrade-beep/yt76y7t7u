...
const BkashDeposit: React.FC = () => {
  ...
  const t = {
    BN: {
      ...
      successDesc: `আপনার bKash ম্যানুয়াল জমার অনুরোধ গ্রহণ করা হয়েছে। আমাদের সাপোর্ট টিম মার্চেন্ট রেকর্ডের সাথে আপনার লেনদেন আইডিটি যাচাই করবে।`,
      orderId: "অর্ডার আইডি",
      amount: "পরিমাণ",
      return: "টার্মিনালে ফিরে যান",
      warning: "অনুগ্রহ করে প্রেরিত পরিমাণ পরিবর্তন করবেন না",
      step1: "ক্যাশ আউট নম্বর কপি করুন",
      step1Desc: appConfig.bkash_step1_bn || `নিচের নম্বরে bKash অ্যাপ বা ক্যাশআউট মেনু দিয়ে টাকা পাঠান।`,
      ...
      guideTitle: `bKash ম্যানুয়াল ডিপোজিট করার নিয়ম`,
      guide: appConfig.bkash_guide_bn ? appConfig.bkash_guide_bn.split('\n') : [
        "১. আপনার bKash অ্যাপ অথবা মোবাইল মেনু ডায়াল করুন (*২৪৭#)।",
        "২. ক্যাশ আউট (Cash Out) অপশনটি নির্বাচন করুন।",
        "৩. উপরে দেওয়া bKash নম্বরটি কপি করে প্রবেশ করান।",
